...
const TEMPLATE_LABELS: Record<string, string> = {
  ...
  jdy_jst_item_master_mirror_observation: "简道云聚水潭商品镜像·观测",
  jdy_jst_bundle_bom_mirror_observation: "简道云聚水潭组合BOM镜像·观测",
  jdy_tmall_bundle_detail_observation: "简道云天猫组合明细·观测",
  jdy_pdd_sku_cost_standard_observation: "简道云拼多多SKU成本标准·观测",
  jdy_vip_bundle_crosswalk_observation: "简道云唯品会组合对照·观测",
  jdy_finance_goods_master_observation: "简道云财务货品档案·观测",
  jdy_finance_operating_cost_observation: "简道云财务运营成本·观测",
  ...
  jdy_brand_master_observation: "简道云品牌档案·观测",
};
