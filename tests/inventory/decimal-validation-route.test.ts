...
const request = (body: unknown) => new NextRequest("http://localhost/api/test", { method: "POST", headers: { "content-type": "application/json", "x-scm-stock-create-contract": "2" }, body: JSON.stringify({ requestKey: "93213c9b-7b03-401e-99df-f8b92fbed748", ...(body as object) }) });
