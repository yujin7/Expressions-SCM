    ...
    try {
      ...
      await db.insert(schema.stagingRows).values([
        ...
        },
        {
          ...
          status: "pending",
          targetTable: "jdy_purchase_demand_observation",
          payload: { data: { requestedAt: "2024-11-01", requestedQty: "100", purchasedQty: "80", purchaseStatus: "部分采购", skuCode: "SKU-SECRET-A" } },
        },
        {
          importJobId: latestDemand.id,
          rowNo: 2,
          status: "validated",
          targetTable: "jdy_purchase_demand_observation",
          payload: { data: { requestedAt: "2024-12-10", requestedQty: "20.5", purchasedQty: "0", purchaseStatus: "未采购", supplierName: "供应商秘密" } },
        },
        {
          importJobId: countJob.id,
          rowNo: 1,
          ...
          payload: { data: { startedAt: "2024-07-20", finishedAt: "2024-07-21", lossQty: "3", gainQty: "0", warehouseName: "仓库秘密" } },
        },
        {
          importJobId: countJob.id,
          rowNo: 2,
