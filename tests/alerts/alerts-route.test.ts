...
interface Row { id: number; category: string; severity: string | null; ackedAt: string | null; ackedByName: string | null; dedupeKey: string | null; ownerRole: string | null; sourceRule: string | null; paramsSnapshot: Record<string, unknown> | null }
