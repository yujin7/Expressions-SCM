...
const LEGACY_MENU: LegacyNode[] = [
  ...
  { key: "inventory", label: "库存", children: [
    {"key": "/inventory/balance", "label": "库存余额"}, {"key": "/inventory/ledger", "label": "库存流水"}, {"key": "/inventory/docs", "label": "库存单据"}, {"key": "/inventory/locations", "label": "库位作业"}, {"key": "/inventory/count", "label": "盘点任务"}, {"key": "/inventory/expiry", "label": "效期批次"}, {"key": "/inventory/batch-trace", "label": "批次追溯"}, {"key": "/report/inbound-calendar", "label": "到货日历"}, {"key": "/report/sku-360", "label": "SKU 360 事件轴"}, {"key": "/report/demand?tab=stock_summary", "label": "总库存核对"}, {"key": "/report/jiediao", "label": "借调对账"}, {"key": "/inventory/position", "label": "库存日级走向"}, {"key": "/inventory/alerts", "label": "库存预警与爆单"}, {"key": "/inventory/warehouses", "label": "各仓库存与周转"}, {"key": "/inventory/transfer-routes", "label": "调拨线路与费用"},
  ] },
  { key: "quality", label: "质量与合规", children: [
  ...
  { key: "admin", label: "系统管理", children: [
    {"key": "/admin/users", "label": "用户管理"}, {"key": "/admin/audit", "label": "审计日志"}, {"key": "/admin/params", "label": "运行参数"}, {"key": "/admin/approval-config", "label": "审批节点配置"}, {"key": "/admin/health", "label": "运维面板"},
  ] },
];
...
const LEGACY_MENU_ROLES: Record<string, string[]> = {
  ...
  "/master/supply-params": ["pmc", "purchasing"],
